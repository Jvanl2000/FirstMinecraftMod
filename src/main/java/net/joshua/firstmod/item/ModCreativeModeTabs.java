...
public class ModCreativeModeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> ALEXANDRITE_ITEMS_TAB = CREATIVE_MODE_TABS.register(
            "alexandrite_items_tab", () -> CreativeModeTab.builder()
                    .icon(() -> new ItemStack(ModItems.ALEXANDRITE.get()))
                    .title(Component.translatable("creativetab.firstmod.alexandrite"))
                    .displayItems((ItemDisplayParameters, output) -> {
                        ...
                        output.accept(ModItems.CLOAK_RELIC.get());
                        output.accept(ModBlocks.MAGIC_BLOCK.get());
                        output.accept(ModBlocks.HELLSTONE_BLOCK.get());
                        output.accept(ModBlocks.COLD_BLOCK.get());
